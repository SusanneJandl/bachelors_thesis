...
The big difference to this work is either the available hardware or if there are hardware restrictions, an online platform is used, and the models do not run locally on the device.
...
This thesis focuses on running a chatbot with less hardware resources and different devices, like a Windows laptops with 32, and 8 GB of RAM using only CPU.
...
Other papers, such as #cite(<Athanasios:2024>) @Fan:2024 @Gao:2023 @Golla:2024 @Ko:2024 @Kofler:2025 @Liu:2024 @Lewis:2020 @Yee:2024 @Zhang:2025, include components discussed in this thesis, like using Ollama, RAG, and LLMs in general and are referenced for general information about used technologies.
