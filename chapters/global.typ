...
#let titles = (
  ...
  hypothesis2: "Hypothesis 2: Efficiency of OllamaSharp vs. Langflow vs. Ollama in Python",
  method: "Method",
  ...
  ollama: "Ollama",
  cloudlocal: "Cloud vs. Local",
  concept: "Concept",
  finetuningapproach: "Fine-Tuning a Pre-Trained Model",
  langflow: "Using Langflow",
  csharpapproach: "OllamaSharp and Python.Included in C#",
  finalimplementation: "Concept of the Final Implementation",
