...
AppContext.SetSwitch("System.Runtime.Serialization.EnableUnsafeBinaryFormatterSerialization",
true);
...
while (true)
{
    ...
    string prompt = $"Answer the question: {message} in the language it was asked. Use the following information for your answer: {context}.";
